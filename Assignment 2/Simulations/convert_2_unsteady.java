...
public class convert_2_unsteady extends StarMacro {
  ...
  private void execute0() {
    ...
    implicitUnsteadySolver_0.getTimeStep().setValue(0.04);
    ...
    physicalTimeStoppingCriterion_0.getMaximumTime().setValue(5.0);
