// STAR-CCM+ macro: data_export2.java
...
public class data_export2 extends StarMacro {
  ...
  private void execute0() {
    ...
    YAxisType yAxisType_9 = 
      ((YAxisType) xYPlot_9.getYAxes().getAxisType("Y Type 1"));

    InternalDataSet internalDataSet_30 = 
      ((InternalDataSet) yAxisType_9.getDataSetManager().getDataSet("Region: Body 1.upper"));

    yAxisType_9.getDataSetManager().writeCSVDataSet(internalDataSet_30, resolvePath("C:\\Users\\Ali\\Documents\\MEGA\\University\\5th Year\\CFD 5\\Assignment 1\\Simulation Files\\Data Export\\upper_cp.csv"), ",");

    InternalDataSet internalDataSet_31 = 
      ((InternalDataSet) yAxisType_9.getDataSetManager().getDataSet("Region: Body 1.chamfer"));

    yAxisType_9.getDataSetManager().writeCSVDataSet(internalDataSet_31, resolvePath("C:\\Users\\Ali\\Documents\\MEGA\\University\\5th Year\\CFD 5\\Assignment 1\\Simulation Files\\Data Export\\chamfer_cp.csv"), ",");

    InternalDataSet internalDataSet_32 = 
      ((InternalDataSet) yAxisType_9.getDataSetManager().getDataSet("Region: Body 1.lower"));

    yAxisType_9.getDataSetManager().writeCSVDataSet(internalDataSet_32, resolvePath("C:\\Users\\Ali\\Documents\\MEGA\\University\\5th Year\\CFD 5\\Assignment 1\\Simulation Files\\Data Export\\lower_cp.csv"), ",");

    MonitorPlot monitorPlot_0 = 
      ((MonitorPlot) simulation_0.getPlotManager().getPlot("CL Plot"));

    MonitorDataSet monitorDataSet_0 = 
      ((MonitorDataSet) monitorPlot_0.getDataSetManager().getDataSet("CL Monitor"));

    monitorPlot_0.getDataSetManager().writeCSVDataSet(monitorDataSet_0, resolvePath("C:\\Users\\Ali\\Documents\\MEGA\\University\\5th Year\\CFD 5\\Assignment 1\\Simulation Files\\Data Export\\CL_hist.csv"), ",");

    MonitorDataSet monitorDataSet_1 = 
      ((MonitorDataSet) monitorPlot_0.getDataSetManager().getDataSet("CL_Pressure Monitor"));

    monitorPlot_0.getDataSetManager().writeCSVDataSet(monitorDataSet_1, resolvePath("C:\\Users\\Ali\\Documents\\MEGA\\University\\5th Year\\CFD 5\\Assignment 1\\Simulation Files\\Data Export\\CLP_hist.csv"), ",");

    MonitorDataSet monitorDataSet_2 = 
      ((MonitorDataSet) monitorPlot_0.getDataSetManager().getDataSet("CL_Shear Monitor"));

    monitorPlot_0.getDataSetManager().writeCSVDataSet(monitorDataSet_2, resolvePath("C:\\Users\\Ali\\Documents\\MEGA\\University\\5th Year\\CFD 5\\Assignment 1\\Simulation Files\\Data Export\\CLS_hist.csv"), ",");
  }
}
